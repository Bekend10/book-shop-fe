      ...
      <div v-if="book" class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="space-y-6">
          <div>
            ...
            <p class="text-xl text-gray-600 dark:text-gray-300 mb-4">Tác giả: {{ book.author }}</p>
            ...
            <div class="flex items-center mb-4">
              ...
              <span class="text-gray-500 dark:text-gray-400">({{ book.reviews }} đánh giá)</span>
            </div>
            ...
            <div class="flex items-center space-x-4 mb-6">
              ...
              <span :class="[
                ...
                {{ book.inStock ? `Còn ${book.stock} cuốn` : 'Hết hàng' }}
              </span>
            </div>
          </div>

          <!-- Quantity Selector -->
          <div v-if="book.inStock" class="flex items-center space-x-4">
          ...
          <div class="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <span class="font-medium ml-2 text-gray-900 dark:text-white">{{ book.author }}</span>
              </div>
              <div>
                <span class="text-gray-600 dark:text-gray-300">Danh mục:</span>
                <span class="font-medium ml-2 text-gray-900 dark:text-white">{{ book.category }}</span>
              </div>
              <div>
              ...
              <div>
                <span class="text-gray-600 dark:text-gray-300">Tình trạng:</span>
                <span class="font-medium ml-2 text-gray-900 dark:text-white">{{ book.inStock ? 'Còn hàng' : 'Hết hàng' }}</span>
              </div>
            </div>
          </div>
        </div>
